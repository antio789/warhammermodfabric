...
public class WarpbulletRender extends EntityRenderer<WarpBulletEntity> {
    ...
    public WarpbulletRender(EntityRenderDispatcher renderManagerIn) {
        super(renderManagerIn);
        model=new WarpBulletModel();
    }

    public void render(WarpBulletEntity p_225623_1_, float p_225623_2_, float p_225623_3_, PoseStack p_225623_4_, MultiBufferSource p_225623_5_, int p_225623_6_) {
